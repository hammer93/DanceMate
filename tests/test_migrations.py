...
def test_migrations_are_discovered_in_order():
    ...
    assert [m.name for m in found] == [
        ...
        "025_gwangju_region",
        "026_dj_and_feedback",
        "027_direct_source_expansion",
        "028_venue_genres",
        "029_fee_display_text",
        "030_timeline_confirmation_settings",
        "031_master_data_delete_action",
        "032_venue_seed_note_cleanup",
        "033_event_terminology",
        "034_event_term_practica_alias",
        "035_public_directory",
        "036_community_discovery",
        ...
        "042_incremental_engine_reextract",
        "043_incremental_normalization",
    ]
    assert [m.version for m in found] == ["001", "002", "003", "004", "005", "006", "007", "008", "009", "010", "011", "012", "013", "014", "015", "016", "017", "018", "019", "020", "021", "022", "023", "024", "025", "026", "027", "028", "029", "030", "031", "032", "033", "034", "035", "036", "037", "038", "039", "040", "041", "042", "043"]
