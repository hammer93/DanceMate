...
- Product Runtime: v0.94.0 (direct source acquisition + Event source evidence, migration 041)
  - v0.92.6은 ROCKPro64의 직전 운영 기준점이었다 (migration 040).
...
| Endpoint          | Purpose                                                      |
|-------------------|--------------------------------------------------------------|
| `GET /health`     | cheap liveness probe: `{"status":"ok","version":"0.94.0"}`      |
